    ...
    analysis: {
      ...
      indicators: {
        "4h": {
          ...
          ichimoku: { tenkan: 97000, kijun: 96500, senkouA: 96000, senkouB: 95500, chikou: 97000 },
          superTrend: { direction: "bullish", value: 96000 },
          fibonacci: { level0: 0, level236: 0, level382: 0, level500: 0, level618: 0, level786: 0, level100: 0 },
      ...
      marketStructure: { trend: "Bullish", higherHighs: true, higherLows: true, lowerHighs: false, lowerLows: false },
      volumeAnalysis: { volumeTrend: "increasing", anomalousVolume: false, averageVolume30d: 1000, recentVolumes: [] },
      volatility: { dailyVolatility: 3, weeklyVolatility: 8, atr: 500 },
      levels: { nearestSupport: 95500, nearestResistance: 98500, strongLevels: [], liquidityZones: [] },
      ...
      globalMarket: { totalMarketCap: 3e12, totalVolume: 1e11, marketCapChange24h: 1.5 },
      marketRegime: {
        regime: "Strong Bull",
        confidence: 78,
        score: 0.55,
